...
**[LeaderBoard-Project]** is a project of creating a Leaderboard using Api thereby sending and receiving data from Api.
...
```sh
  cd my-folder
  git clone https://github.com/zunairkhan811/Leaderboard-project.git
```
